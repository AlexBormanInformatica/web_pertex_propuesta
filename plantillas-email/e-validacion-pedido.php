							...
							<table role='presentation' style='width:100%;border-collapse:collapse;border:0;border-spacing:0;'>
								<tr>
									<td style='padding:0 0 36px 0;color:#191D34;'>
										<h1 style='font-size:24px;margin:0 0 20px 0;font-family:Arial,sans-serif;'><?= buscarTextoConReturn("WEB", "correos", "prep_tit1", "", $_SESSION['idioma']) ?></h1>
										<p style='margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;'><?= buscarTextoConReturn("WEB", "correos", "prep_p1", "", $_SESSION['idioma']) ?></p>
										<p style='margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;'><?= buscarTextoConReturn("WEB", "correos", "prep_p2", "", $_SESSION['idioma']) ?></p>
						...
						<td style='padding:30px;background:#191D34;'>
							<table role='presentation' style='width:100%;border-collapse:collapse;border:0;border-spacing:0;font-size:9px;font-family:Arial,sans-serif;'> "
								<tr>
									...
									<h2 style='font-size:18px;margin:0 0 20px 0;font-family:Arial,sans-serif;color:#ffffff;'>¿Cómo es el proceso completo de un pedido?</h2>
								</tr>
								<tr>
									<td style='padding:0;' align='center'>
								...
								<tr>
									<td style='padding:0;width:50%;' align='center'>
										<p style='margin:0;font-size:14px;line-height:16px;font-family:Arial,sans-serif;color:#000;'>
											&reg; Personalizaciones textiles 2022<br /><a href='https://personalizacionestextiles.com/<?= buscarTextoConReturn("WEB", "paginas" , "aviso-legal" , "" , $_SESSION['idioma']) ?>' style='color:#000;text-decoration:underline;'>Aviso legal</a> | <a href='https://personalizacionestextiles.com/<?= buscarTextoConReturn("WEB", "paginas" , "politica-privacidad" , "" , $_SESSION['idioma']) ?>' style='color:#000;text-decoration:underline;'>Política de privacidad</a>
										</p>
