...
<head>
    ...
    <title><?= buscarTexto("WEB", "tiradores", "tiradores_title_seo", "", $_SESSION['idioma']); ?></title>
    <meta name="description" content="<?= buscarTexto("WEB", "tiradores", "tiradores_description_seo", "", $_SESSION['idioma']); ?>">
    <link rel="canonical" href="https://personalizacionestextiles.com/tiradores">
    <meta property="og:locale" content="es_ES">
    <meta property="og:site_name" content="personalizacionestextiles" />
    <meta property="og:url" content="https://personalizacionestextiles.com/tiradores" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="<?= buscarTexto("WEB", "tiradores", "tiradores_og:title_seo", "", $_SESSION['idioma']); ?>" />
    <meta property="og:description" content="<?= buscarTexto("WEB", "tiradores", "tiradores_og:description_seo", "", $_SESSION['idioma']); ?>" />
    ...
    try {
        $sql = "SELECT * FROM productos p INNER JOIN consejoslavado co ON  co.idconsejoslavado = p.consejoslavado_idconsejoslavado WHERE categorias_id_categoria = 3";
    ...
    <main>
        <div class="single-slider slider-height2 d-flex align-items-center" data-background="imagenes/banner-tiradores.png">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="hero-cap text-center">
                            <h1 class="title-product"><?= buscarTexto("WEB", "tiradores", "tiradores_tit-principal", "", $_SESSION['idioma']); ?></h1>
                        </div>
                    </div>
                </div>
            </div>
