...
<head>
    ...
    <title><?= buscarTexto("WEB", "etiquetas", "etiquetas_title_seo", "", $_SESSION['idioma']); ?></title>
    <meta name="description" content="<?= buscarTexto("WEB", "etiquetas", "etiquetas_description_seo", "", $_SESSION['idioma']); ?>">
    <link rel="canonical" href="https://personalizacionestextiles.com/etiquetas">
    <meta property="og:locale" content="es_ES">
    <meta property="og:site_name" content="personalizacionestextiles" />
    <meta property="og:url" content="https://personalizacionestextiles.com/etiquetas" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="<?= buscarTexto("WEB", "etiquetas", "etiquetas_og:title_seo", "", $_SESSION['idioma']); ?>" />
    <meta property="og:description" content="<?= buscarTexto("WEB", "etiquetas", "etiquetas_og:description_seo", "", $_SESSION['idioma']); ?>" />
    <meta property="og:image" content="https://personalizacionestextiles.com/images/logo.png" />

    <?php
    include("assets/_partials/header.php");
    try {
        $sql = "SELECT * FROM productos p INNER JOIN consejoslavado co ON  co.idconsejoslavado = p.consejoslavado_idconsejoslavado WHERE categorias_id_categoria = 5";
    ...
    <main>
        <div class="single-slider slider-height2 d-flex align-items-center bg-dark" data-background="imagenes/banner-etiquetas.png" style="background-image: url(&quot;imagenes/banner-marcajes.png&quot;);">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="hero-cap text-center">
                            <h1 class="title-product"><?= buscarTexto("WEB", "etiquetas", "etiquetas_tit-principal", "", $_SESSION['idioma']); ?></h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row  p-all-40">
                    <?php foreach ($results as $result) { ?>
                        <div class=" section-top-border-2">
                            <div class="row model-product p-lr-10">
                                ...
                                <div class="col-md-8 mt-sm-20">
                                    ...
                                    <!-- Button trigger modal // CONSEJOS DE LAVADO -->
