...
<head>
    ...
    <title>Gracias por tu encargo</title>
...
<body>
    <div class="container">
        <div class="row justify-content-center align-items-center" style="height: 100h;">
            <div class="col-8">
    ...
    <script>
        document.getElementById("generarPDF").addEventListener("click", function() {
            ...
            form.method = "post";
            form.action = "pdf-encargo.php";
            form.target = "_blank"; // Abre en una nueva ventana o pestaña

            // Crea un campo de entrada oculto para el ID
