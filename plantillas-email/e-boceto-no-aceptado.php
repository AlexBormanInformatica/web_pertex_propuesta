								...
								<tr>
									<td style='padding:0;width:50%;' align='center'>
										<p style='margin:0;font-size:14px;line-height:16px;font-family:Arial,sans-serif;color:#000;'>
											&reg; Personalizaciones textiles 2022<br /><a href='https://personalizacionestextiles.com/aviso-legal' style='color:#000;text-decoration:underline;'><?=buscarTextoConReturn("WEB", "paginas", "aviso-legal", "", $_SESSION['idioma'])?></a> | <a href='https://personalizacionestextiles.com/<?= buscarTextoConReturn("WEB", "paginas" , "politica-privacidad" , "" , $_SESSION['idioma']) ?>' style='color:#000;text-decoration:underline;'></a>
										</p>
