							...
							<table role='presentation' style='width:100%;border-collapse:collapse;border:0;border-spacing:0;'>
								<tr>
									<td style='padding:0 0 36px 0;color:#191D34;'>
										<h1 style='font-size:24px;margin:0 0 20px 0;font-family:Arial,sans-serif;'><?= buscarTextoConReturn("WEB", "correos", "pagoconf_tit1", "", $_SESSION['idioma']) ?></h1>
										<p style='margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;'><?= buscarTextoConReturn("WEB", "correos", "pagoconf_p1", "", $_SESSION['idioma']) ?></p>
										<p style='margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;'><?= buscarTextoConReturn("WEB", "correos", "pagoconf_p2", "", $_SESSION['idioma']) ?>  <a href='https://personalizacionestextiles.com/<?= buscarTextoConReturn("WEB", "paginas" , "envio" , "" , $_SESSION['idioma']) ?>' style='color:#00953e;'>entregas y gastos de envío</a></p>
