...
<head>
    ...
    <title><?= buscarTexto("WEB", "404", "subtit", "", $_SESSION['idioma']); ?> | Personalizaciones textiles</title>
                ...
                <div class="col-md-12 text-center">
                    <div class="block">
                        <div class="p-tb-25 shadow  caja-height-404 ">
                            <h1 class=" fs-pag m-b-25 color-red"><?= buscarTexto("WEB", "404", "tit", "", $_SESSION['idioma']); ?></h1>
                            <h2 class="fs-pag"><?= buscarTexto("WEB", "404", "subtit", "", $_SESSION['idioma']); ?></h2>
                            <p class=" m-t-40"><?= buscarTexto("WEB", "404", "p1", "", $_SESSION['idioma']); ?><br><?= buscarTexto("WEB", "404", "p1-br", "", $_SESSION['idioma']); ?></p>
                            <a href="." class="btn hero-btn"><?= buscarTexto("WEB", "404", "btn", "", $_SESSION['idioma']); ?></a>
                        </div>
                    </div>
                </div>
            </div>
