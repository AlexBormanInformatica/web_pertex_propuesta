...
<head>
    ...
    <title><?= buscarTexto("WEB", "pulseras", "pulseras_title_seo", "", $_SESSION['idioma']); ?></title>
    <meta name="description" content="<?= buscarTexto("WEB", "pulseras", "pulseras_description_seo", "", $_SESSION['idioma']); ?>">
    <link rel="canonical" href="https://personalizacionestextiles.com/pulseras">
    <meta property="og:locale" content="es_ES">
    <meta property="og:site_name" content="personalizacionestextiles" />
    <meta property="og:url" content="https://personalizacionestextiles.com/pulseras" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="<?= buscarTexto("WEB", "pulseras", "pulseras_og:title_seo", "", $_SESSION['idioma']); ?>" />
    <meta property="og:description" content="<?= buscarTexto("WEB", "pulseras", "pulseras_og:description_seo", "", $_SESSION['idioma']); ?>" />
    ...
    <main>
        <div class="single-slider slider-height2 d-flex align-items-center bg-dark" data-background="imagenes/banner-pulseras.png" style="background-image: url(&quot;imagenes/banner-marcajes.png&quot;);">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="hero-cap text-center">
                            <h1 class="title-product"><?= buscarTexto("WEB", "pulseras", "pulseras_tit-principal", "", $_SESSION['idioma']); ?></h1>
                        </div>
                    </div>
                </div>
            </div>
