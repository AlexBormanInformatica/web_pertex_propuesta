        ...
        <div class="container mt-30 p-all-30">
            ...
            <form id="formSubirBoceto" action="DAOs/subir-bocetoDAO.php" method="post" enctype="multipart/form-data">
                <div class="row ">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <select class="mb-3 nice-select" required name="numPer" id="numPer" type="text">
                                    ...
                                    ?>
                                        <option value="<?= $result->idlineaPedido ?>"><?= $result->idlineaPedido ?></option>
                                    <?php } ?>
                                </select>
                    ...
                    <div class="col-md-6">
                        <!--Imagen-->
                        <label class="mb-3">Imagen del cliente:</label>
                        <label for="imagen_cc" class="btn mt-2"><?= buscarTexto("WEB", "personaliza-tu-producto", "ptp_confirma-prop-intelectual-btn", "", $_SESSION['idioma']); ?></label>
                        <input style="visibility:hidden;" name="imagen_cc" id="imagen_cc" type="file" /><br>
                        <div class="m-tb-10">
                            <img style="max-width: 100px;" id="pre_boceto">
                        </div>
                    </div>
                    <div class="p-all-30">
                        <button type="submit" class="btn-fino  mt-20">Subir imagen</button>
                    </div>
                </div>
            </form>
        </div>
